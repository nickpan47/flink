...
public class MapItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MapItem(CharSequence type, CharSequence value) {
    this.type = type;
    this.value = value;
  }
   ...
   */
  public static MapItem.Builder newBuilder() {
    return new MapItem.Builder();
  }
   ...
   * @return A new MapItem RecordBuilder
   */
  public static MapItem.Builder newBuilder(MapItem.Builder other) {
    return new MapItem.Builder(other);
  }
   ...
   * @return A new MapItem RecordBuilder
   */
  public static MapItem.Builder newBuilder(MapItem other) {
    return new MapItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MapItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(MapItem.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public MapItem.Builder setType(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public MapItem.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public MapItem.Builder setValue(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public MapItem.Builder clearValue() {
      value = null;

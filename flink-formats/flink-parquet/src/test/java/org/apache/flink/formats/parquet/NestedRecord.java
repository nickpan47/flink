...
public class NestedRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public Long foo;
  @Deprecated public java.util.Map<CharSequence, CharSequence> spamMap;
  @Deprecated public Bar bar;
  @Deprecated public java.util.List<Long> arr;
  @Deprecated public java.util.List<CharSequence> strArray;
  @Deprecated public java.util.Map<CharSequence, MapItem> nestedMap;
  @Deprecated public java.util.List<ArrayItem> nestedArray;
   ...
   */
  public NestedRecord(Long foo, java.util.Map<CharSequence, CharSequence> spamMap, Bar bar, java.util.List<Long> arr, java.util.List<CharSequence> strArray, java.util.Map<CharSequence, MapItem> nestedMap, java.util.List<ArrayItem> nestedArray) {
    this.foo = foo;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: spamMap = (java.util.Map<CharSequence, CharSequence>)value$; break;
    case 2: bar = (Bar)value$; break;
    case 3: arr = (java.util.List<Long>)value$; break;
    case 4: strArray = (java.util.List<CharSequence>)value$; break;
    case 5: nestedMap = (java.util.Map<CharSequence, MapItem>)value$; break;
    case 6: nestedArray = (java.util.List<ArrayItem>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.Map<CharSequence, CharSequence> getSpamMap() {
    return spamMap;
  }
   ...
   * @param value the value to set.
   */
  public void setSpamMap(java.util.Map<CharSequence, CharSequence> value) {
    this.spamMap = value;
  }
   ...
   */
  public java.util.List<Long> getArr() {
    return arr;
  }
   ...
   * @param value the value to set.
   */
  public void setArr(java.util.List<Long> value) {
    this.arr = value;
  }
   ...
   */
  public java.util.List<CharSequence> getStrArray() {
    return strArray;
  }
   ...
   * @param value the value to set.
   */
  public void setStrArray(java.util.List<CharSequence> value) {
    this.strArray = value;
  }
   ...
   */
  public java.util.Map<CharSequence, MapItem> getNestedMap() {
    return nestedMap;
  }
   ...
   * @param value the value to set.
   */
  public void setNestedMap(java.util.Map<CharSequence, MapItem> value) {
   ...
   */
  public java.util.List<ArrayItem> getNestedArray() {
    return nestedArray;
  }
   ...
   * @param value the value to set.
   */
  public void setNestedArray(java.util.List<ArrayItem> value) {
   ...
   */
  public static NestedRecord.Builder newBuilder() {
    return new NestedRecord.Builder();
  }
   ...
   * @return A new NestedRecord RecordBuilder
   */
  public static NestedRecord.Builder newBuilder(NestedRecord.Builder other) {
    return new NestedRecord.Builder(other);
  }
   ...
   * @return A new NestedRecord RecordBuilder
   */
  public static NestedRecord.Builder newBuilder(NestedRecord other) {
    return new NestedRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NestedRecord>
    ...
    private Long foo;
    private java.util.Map<CharSequence, CharSequence> spamMap;
    private Bar bar;
    private Bar.Builder barBuilder;
    private java.util.List<Long> arr;
    private java.util.List<CharSequence> strArray;
    private java.util.Map<CharSequence, MapItem> nestedMap;
    private java.util.List<ArrayItem> nestedArray;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(NestedRecord.Builder other) {
      super(other);
      ...
      if (other.hasBarBuilder()) {
        this.barBuilder = Bar.newBuilder(other.getBarBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(NestedRecord other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.foo)) {
        this.foo = data().deepCopy(fields()[0].schema(), other.foo);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder setFoo(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder clearFoo() {
      foo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder setSpamMap(java.util.Map<CharSequence, CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder clearSpamMap() {
      spamMap = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder setBar(Bar value) {
    ...
    public Bar.Builder getBarBuilder() {
      if (barBuilder == null) {
        if (hasBar()) {
          setBarBuilder(Bar.newBuilder(bar));
        } else {
          setBarBuilder(Bar.newBuilder());
        }
      }
      return barBuilder;
    }
     ...
     * @return This builder.
     */
    public NestedRecord.Builder setBarBuilder(Bar.Builder value) {
      clearBar();
      barBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder clearBar() {
      bar = null;
      barBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder setArr(java.util.List<Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder clearArr() {
      arr = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder setStrArray(java.util.List<CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder clearStrArray() {
      strArray = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder setNestedMap(java.util.Map<CharSequence, MapItem> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder clearNestedMap() {
      nestedMap = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder setNestedArray(java.util.List<ArrayItem> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public NestedRecord.Builder clearNestedArray() {
      nestedArray = null;
    ...
    public NestedRecord build() {
      try {
        ...
        record.spamMap = fieldSetFlags()[1] ? this.spamMap : (java.util.Map<CharSequence, CharSequence>) defaultValue(fields()[1]);
        if (barBuilder != null) {
          record.bar = this.barBuilder.build();
        } else {
          record.bar = fieldSetFlags()[2] ? this.bar : (Bar) defaultValue(fields()[2]);
        }
        record.arr = fieldSetFlags()[3] ? this.arr : (java.util.List<Long>) defaultValue(fields()[3]);
        record.strArray = fieldSetFlags()[4] ? this.strArray : (java.util.List<CharSequence>) defaultValue(fields()[4]);
        record.nestedMap = fieldSetFlags()[5] ? this.nestedMap : (java.util.Map<CharSequence, MapItem>) defaultValue(fields()[5]);
        record.nestedArray = fieldSetFlags()[6] ? this.nestedArray : (java.util.List<ArrayItem>) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {

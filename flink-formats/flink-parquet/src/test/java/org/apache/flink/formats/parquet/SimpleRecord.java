...
public class SimpleRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public CharSequence bar;
   ...
   */
  public SimpleRecord(Long foo, CharSequence bar, java.util.List<Long> arr) {
    this.foo = foo;
    this.bar = bar;
    this.arr = arr;
  }
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: bar = (CharSequence)value$; break;
    case 2: arr = (java.util.List<Long>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setBar(CharSequence value) {
    this.bar = value;
  }
   ...
   */
  public static SimpleRecord.Builder newBuilder() {
    return new SimpleRecord.Builder();
  }
   ...
   * @return A new SimpleRecord RecordBuilder
   */
  public static SimpleRecord.Builder newBuilder(SimpleRecord.Builder other) {
    return new SimpleRecord.Builder(other);
  }
   ...
   * @return A new SimpleRecord RecordBuilder
   */
  public static SimpleRecord.Builder newBuilder(SimpleRecord other) {
    return new SimpleRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SimpleRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(SimpleRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(SimpleRecord other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.foo)) {
        this.foo = data().deepCopy(fields()[0].schema(), other.foo);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public SimpleRecord.Builder setFoo(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SimpleRecord.Builder clearFoo() {
      foo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SimpleRecord.Builder setBar(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SimpleRecord.Builder clearBar() {
      bar = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SimpleRecord.Builder setArr(java.util.List<Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SimpleRecord.Builder clearArr() {
      arr = null;
    ...
    public SimpleRecord build() {
      try {
        ...
        record.bar = fieldSetFlags()[1] ? this.bar : (CharSequence) defaultValue(fields()[1]);
        record.arr = fieldSetFlags()[2] ? this.arr : (java.util.List<Long>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
